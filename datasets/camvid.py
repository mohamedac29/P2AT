...
class CamVid(BaseDataset):
    def __init__(self, 
        ...
        #         [ 4.3505, 35.0686, 3.4997, 14.0079, 8.0937, 32.6272, 28.6828, 14.8280, 38.3528, 37.4353,
        #         18.7975])
        # self.class_weights = np.array(
        #         [0.2778, 0.1770, 4.7280, 0.1358, 0.7816, 0.3785, 3.7939, 2.5866, 0.8480, 6.5770, 5.8139, 1.2184]) # Mdian Frequency
        # elf.class_weight = np.array(
